  ...
  return (
    <div className='register'>
      <div className="row justify-content-center mt-5">
        <div className="col-md-3 mt-5 text-center shadow-lg p-3 mb-5 bg-info rounded">
          ...
          <div>
            ...
            />
            <button onClick={register} className="btn-success btn-primary rounded-pill mt-3 mb-3">REGISTER</button>
            <br/>
